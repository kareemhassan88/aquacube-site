...
const t = {
  en: {
    ...
    hero: {
      ...
      stat1n: "4", stat1l: "Product Lines", stat2n: "Multi", stat2l: "Sector", stat2tip: "Residential · Commercial · Agricultural · Institutional · Municipal · Humanitarian", stat3n: "IoT", stat3l: "Enabled"
    },
    cards: {
      label: "Our Solutions", title: "Four Systems, Frontier Innovation",
      subtitle: "Each AquaCube unit is purpose-built for a specific water treatment challenge — deploy individually or combine into a complete integrated water management system.",
  ...
  ar: {
    ...
    hero: {
      ...
      stat1n: "4", stat1l: "خطوط إنتاج", stat2n: "متعدد", stat2l: "القطاعات", stat2tip: "سكني · تجاري · زراعي · مؤسسي · بلدي · إنساني", stat3n: "IoT", stat3l: "مُفعّل"
    },
    cards: {
      label: "حلولنا", title: "أربعة أنظمة، ابتكار رائد",
      subtitle: "كل وحدة من AquaCube مصممة خصيصاً لتحدٍّ محدد في معالجة المياه — يمكن نشرها بشكل مستقل أو دمجها في نظام متكامل لإدارة المياه.",
...
const productsData = (lang) => [
  {
    id: "greybox", name: "GreyBox",
...
const isReal2 = (url) => url && url.startsWith("/");

// ICONS
const ChevronRight2 = ({ color = AQUA }) => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M9 18l6-6-6-6"/></svg>;
...
const WifiI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M5 12.55a11 11 0 0 1 14.08 0M1.42 9a16 16 0 0 1 21.16 0M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01"/></svg>;
const ShieldI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>;
const SunI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg>;
const CubeI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12"/></svg>;
const ToolI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>;
const GlobeI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>;
const BoltI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>;
const HeartI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>;
const DollarI = () => <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>;
const MailI = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><path d="M22 6l-10 7L2 6"/></svg>;
const PhoneI = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>;
const MapPinI = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={AQUA} strokeWidth="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>;
const ArrowUpI = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5"><path d="M18 15l-6-6-6 6"/></svg>;

const whyIcons = [<CubeI />, <WifiI />, <SunI />, <DollarI />, <ShieldI />, <BoltI />, <HeartI />, <GlobeI />];
const svcIcons = [<ToolI />, <CubeI />, <BoltI />, <WifiI />, <ShieldI />, <GlobeI />, <SunI />, <HeartI />];
    ...
    <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: solid ? "rgba(10,22,40,0.97)" : "transparent", backdropFilter: solid ? "blur(20px)" : "none", borderBottom: solid ? "1px solid rgba(255,255,255,0.06)" : "none", transition: "all 0.3s", padding: "0 24px", direction: isAr ? "rtl" : "ltr" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
        ...
        <div className="nav-desktop" style={{ display: "flex", gap: 24, alignItems: "center" }}>
          {links.map(l => (
            <button key={l.id} onClick={() => setPage(l.id)} style={{ background: "none", border: "none", color: page === l.id ? AQUA : "rgba(255,255,255,0.7)", fontSize: 14, fontWeight: page === l.id ? 600 : 400, cursor: "pointer", padding: "8px 4px", borderBottom: page === l.id ? `2px solid ${AQUA}` : "2px solid transparent", fontFamily: "inherit" }}>{l.label}</button>
          ))}
...
const Hero = ({ setPage, solutionsRef, lang }) => { const tx = t[lang].hero; const isAr = lang === "ar"; return (
...
const ProductCards = ({ setPage, setActiveProduct, solutionsRef, lang }) => { const tx = t[lang].cards; const prods = productsData(lang); const isAr = lang === "ar"; return (
  <section ref={solutionsRef} style={{ padding: "96px 24px", background: WHITE, direction: isAr ? "rtl" : "ltr" }}>
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
        {prods.map(p => (
          <div key={p.id} onClick={() => { setActiveProduct(p.id); setPage("product-detail"); }} style={{ background: WHITE, borderRadius: 16, padding: 24, cursor: "pointer", border: "1px solid #E8EDF2", transition: "all 0.3s ease" }}
            onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-6px)"; e.currentTarget.style.boxShadow = "0 16px 48px rgba(9,61,121,0.1)"; }} onMouseLeave={e => { e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = ""; }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4, color: AQUA, fontSize: 13, fontWeight: 600 }}>{tx.viewDetails} {isAr ? <ChevronLeft /> : <ChevronRight2 />}</div>
          </div>
        ))}
      </div>
    </div>
...
const WhySection = ({ lang }) => { const tx = t[lang].why; const isAr = lang === "ar"; return (
...
const SectorsSection = ({ lang }) => { const tx = t[lang].sectors; const isAr = lang === "ar"; return (
...
const CTASection = ({ setPage, lang }) => { const tx = t[lang].cta; const isAr = lang === "ar"; return (
...
const ProductsHub = ({ setPage, setActiveProduct, lang }) => { const tx = t[lang].productsHub; const prods = productsData(lang); const isAr = lang === "ar"; return (
  <div>
        ...
        {prods.map((p, i) => (
          <div key={p.id} onClick={() => { setActiveProduct(p.id); setPage("product-detail"); }} style={{ display: "flex", alignItems: "center", gap: 48, marginBottom: 24, background: WHITE, borderRadius: 18, padding: 36, cursor: "pointer", border: "1px solid #E8EDF2", flexDirection: i % 2 === 1 ? "row-reverse" : "row", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: "1 1 400px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 4, color: AQUA, fontSize: 14, fontWeight: 600 }}>{tx.viewSpecs} {isAr ? <ChevronLeft /> : <ChevronRight2 />}</div>
            </div>
          </div>
        ))}
      </div>
...
const ProductDetail = ({ productId, setPage, setActiveProduct, lang }) => { const prods = productsData(lang); const p = prods.find(x => x.id === productId) || prods[0]; const others = prods.filter(x => x.id !== productId); const tx = t[lang].detail; const isAr = lang === "ar"; return (
  <div>
    ...
    {p.applications && <section style={{ padding: "64px 24px", background: WHITE, direction: isAr ? "rtl" : "ltr" }}><div style={{ maxWidth: 1100, margin: "0 auto" }}><h2 style={{ fontSize: 26, fontWeight: 700, color: NAVY, marginBottom: 28 }}>{tx.apps}</h2><div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>{p.applications.map((a, i) => (<div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: 16, background: LIGHT_BG, borderRadius: 10 }}><div style={{ width: 8, height: 8, borderRadius: "50%", background: AQUA, flexShrink: 0 }} /><span style={{ fontSize: 14, color: DARK }}>{a}</span></div>))}</div></div></section>}
    <section style={{ padding: "48px 24px", background: LIGHT_BG, direction: isAr ? "rtl" : "ltr" }}><div style={{ maxWidth: 1100, margin: "0 auto" }}><h2 style={{ fontSize: 22, fontWeight: 700, color: NAVY, marginBottom: 20 }}>{tx.other}</h2><div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>{others.map(o => (<div key={o.id} onClick={() => { setActiveProduct(o.id); window.scrollTo(0, 0); }} style={{ display: "flex", alignItems: "center", gap: 16, background: WHITE, borderRadius: 12, padding: 16, cursor: "pointer", border: "1px solid #E8EDF2" }}><div style={{ width: 60, height: 60, borderRadius: 8, background: LIGHT_BG, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, overflow: "hidden", padding: 4 }}><ProductImage src={o.image} alt={o.name} style={{ maxHeight: 52 }} /></div><div><h4 style={{ fontSize: 16, fontWeight: 700, color: NAVY, margin: "0 0 2px" }}>{o.name}</h4><p style={{ fontSize: 13, color: AQUA, margin: 0, fontWeight: 500 }}>{o.tagline}</p></div></div>))}</div></div></section>
  </div>
);};

const ServicesPage = ({ setPage, lang }) => { const tx = t[lang].servicesPage; const svcs = servicesData(lang); const isAr = lang === "ar"; return (
  <div>
    <section style={{ background: `linear-gradient(160deg, ${DARK}, ${NAVY})`, padding: "130px 24px 70px", textAlign: "center", direction: isAr ? "rtl" : "ltr" }}>
      <Logo light height={32} />
      <h1 style={{ fontSize: 42, fontWeight: 700, color: "white", margin: "20px 0 14px" }}>{tx.title}</h1>
...
const ContactPage = ({ lang }) => { const tx = t[lang].contactPage; const isAr = lang === "ar"; const [formType, setFormType] = useState("customer"); return (
  <div>
    <section style={{ background: `linear-gradient(160deg, ${DARK}, ${NAVY})`, padding: "130px 24px 70px", textAlign: "center", direction: isAr ? "rtl" : "ltr" }}>
      <Logo light height={32} />
      <h1 style={{ fontSize: 42, fontWeight: 700, color: "white", margin: "20px 0 14px" }}>{tx.title}</h1>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", gap: 32, flexWrap: "wrap" }}>
        ...
        <div style={{ flex: "1 1 260px" }}>
          <div style={{ background: WHITE, borderRadius: 16, padding: 28, border: "1px solid #E8EDF2", marginBottom: 16 }}>
            ...
            {[{ city: isAr ? "عمّان، الأردن" : "Amman, Jordan" }, { city: isAr ? "القاهرة، مصر" : "Cairo, Egypt" }, { city: isAr ? "الرياض، السعودية" : "Riyadh, Saudi Arabia" }].map((o, i) => (<div key={i} style={{ display: "flex", gap: 12, marginBottom: 16, alignItems: "center" }}><MapPinI /><div style={{ fontSize: 14, fontWeight: 600, color: NAVY }}>{o.city}</div></div>))}
          </div>
          <div style={{ background: WHITE, borderRadius: 16, padding: 28, border: "1px solid #E8EDF2" }}>
            ...
            <div style={{ display: "flex", gap: 12, marginBottom: 14, alignItems: "center" }}><MailI /><span style={{ fontSize: 14, color: DARK }}>admin@aquacube.info</span></div>
            <div style={{ display: "flex", gap: 12, alignItems: "center" }}><PhoneI /><span style={{ fontSize: 14, color: DARK, direction: "ltr", unicodeBidi: "embed" }}>+962 79 150 79 49</span></div>
          </div>
        </div>
      </div>
    </section>
...
const Footer = ({ setPage, setActiveProduct, lang }) => { const tx = t[lang].footer; const navTx = t[lang].nav; const isAr = lang === "ar"; const prods = productsData(lang); return (
      ...
      <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 36, marginBottom: 44 }}>
        <div style={{ minWidth: 220 }}>
          ...
          <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}><MailI /><span style={{ fontSize: 12, color: "rgba(255,255,255,0.5)" }}>admin@aquacube.info</span></div>
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}><PhoneI /><span style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", direction: "ltr", unicodeBidi: "embed" }}>+962 79 150 79 49</span></div>
          </div>
        </div>
